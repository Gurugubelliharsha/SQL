...
-- Insert Data into Customers (Make sure CNUMs exist before inserting into Orders)
...
(3002, 1900.10, '1994-10-03', 2007, 1004), -- Fixed SNUM reference
(3005, 5160.45, '1994-10-03', 2003, 1002), -- Fixed SNUM reference
...
-- 21. Day with the highest total amount ordered.
...
-- 29. Totals of orders for each day, sorted in descending order.
...
-- First, select all salespeople in San Jose.  
-- Second, select all customers in San Jose.  
-- Third, select all orders on Oct 3.  
-- Retain duplicates between last two, but remove duplicates with first query.
